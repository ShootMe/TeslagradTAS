namespace TeslagradStudio {
	partial class Studio {
		...
		private void InitializeComponent() {
			...
			this.tasText = new TeslagradStudio.Controls.RichText();
			...
			this.statusBar.Size = new System.Drawing.Size(384, 44);
			this.statusBar.TabIndex = 1;
			// 
			// lblStatus
			// 
			this.lblStatus.Font = new System.Drawing.Font("Courier New", 11.25F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
			...
			this.tasText.Language = TeslagradStudio.Controls.Language.TAS;
			...
			this.tasText.Size = new System.Drawing.Size(384, 617);
			this.tasText.TabIndex = 0;
			this.tasText.TabLength = 0;
			this.tasText.TextChanged += new System.EventHandler<TeslagradStudio.Controls.TextChangedEventArgs>(this.tasText_TextChanged);
			...
			this.tasText.LineInserted += new System.EventHandler<TeslagradStudio.Controls.LineInsertedEventArgs>(this.tasText_LineInserted);
			this.tasText.LineNeeded += new System.EventHandler<TeslagradStudio.Controls.LineNeededEventArgs>(this.tasText_LineNeeded);
			this.tasText.LineRemoved += new System.EventHandler<TeslagradStudio.Controls.LineRemovedEventArgs>(this.tasText_LineRemoved);
			// 
			// Studio
			// 
